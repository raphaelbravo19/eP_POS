...
// import 'package:attendanceapp/src/ui/screens/widgets/success_dialog_d.dart';
      ...
      return builder(
        localizations.formatMediumDate(selectedFirstDate) +
            (selectedLastDate != null
                ...
                : ""),
        localizations.formatYear(selectedFirstDate),
        Feedback.wrapForTap(
            () => _handleChangeMode(DatePickerMode.year), context),
        Feedback.wrapForTap(
            () => _handleChangeMode(DatePickerMode.day), context),
      ...
      if (day < 1) {
        ...
        if (isSelectedFirstDay &&
          ...
          decoration = new BoxDecoration(
              color: Color(0xFF174285), shape: BoxShape.circle);
          ...
          itemStyle = themeData.accentTextTheme.body2;
          decoration = new BoxDecoration(
              color: Color(0xFF174285), shape: BoxShape.rectangle);
        } else if (disabled) {
...
class _DatePickerDialogState extends State<_DatePickerDialog> {
  ...
  void _handleOk() {
    ...
    if (_selectedFirstDate != null) {
      ...
      if (_selectedLastDate != null) {
        // if (_selectedLastDate.difference(_selectedFirstDate).inDays < 7) {
    ...
    if (_shouldClose) {
      ...
      //     context: context,
      //     builder: (context) {
      //       return SuccessDialogD("Please select less than 8 days");
      //     });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final Widget actions = widget.footerBuilder(_handleCancel, _handleOk);
